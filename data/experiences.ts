...
import { universeExperiences } from "@/data/universe";
...
const baseExperiences: RawExperience[] = [
  /* ═══════════════ MODA LOKANTASI ═══════════════ */
...
export const experiences: RawExperience[] = [...baseExperiences, ...universeExperiences];
