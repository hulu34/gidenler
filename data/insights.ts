...
import { universeSummaries, universePraised, universeComplaints } from "@/data/universe";
 ...
 */
const baseSummaries: Record<string, AISummary> = {
  "ent.moda-lokantasi": {
...
const basePraised: Record<string, ThemeSignal[]> = {
  "ent.moda-lokantasi": [
...
const baseComplaints: Record<string, ThemeSignal[]> = {
  "ent.moda-lokantasi": [
...
export const aiSummaries: Record<string, AISummary> = { ...universeSummaries, ...baseSummaries };
export const praisedThemes: Record<string, ThemeSignal[]> = { ...universePraised, ...basePraised };
export const complaintThemes: Record<string, ThemeSignal[]> = { ...universeComplaints, ...baseComplaints };
